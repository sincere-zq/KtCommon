...
package com.myuluo.zxing.decode;
...
import com.myuluo.zxing.R;
import com.myuluo.zxing.camera.CameraManager;
import com.myuluo.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		int id = message.what;
		if (id == R.id.restart_preview) {// 准备进行下一次扫描
